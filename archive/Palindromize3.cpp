...
double test0() {
	string p0 = "aszsbsz";
	Palindromize3 * obj = new Palindromize3();
	clock_t start = clock();
	string my_answer = obj->getPalindrome(p0);
	clock_t end = clock();
	delete obj;
...
double test3() {
	string p0 = "dfiuwifuqwieubaoiewhroiahw";
	Palindromize3 * obj = new Palindromize3();
	clock_t start = clock();
	string my_answer = obj->getPalindrome(p0);
	clock_t end = clock();
	delete obj;
	cout <<"Time: " <<(double)(end-start)/CLOCKS_PER_SEC <<" seconds" <<endl;
	string p1 = "wfiiwifueiieuueiieufiwiifw";
	cout <<"Desired answer: " <<endl;
	cout <<"\t\"" << p1 <<"\"" <<endl;
	cout <<"Your answer: " <<endl;
	cout <<"\t\"" << my_answer<<"\"" <<endl;
